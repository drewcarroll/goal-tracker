    ...
    <div className="flex flex-col gap-4 rounded-2xl border border-gray-900/[0.06] bg-white p-5 shadow-sm sm:p-6">
      <div>
        ...
        <p className="mt-1 text-base text-gray-700">
          Already scheduled: {plan.locksSpent} / {KEY_BUDGET} keys.
        </p>
      </div>
...
function GoalPicker({
  ...
  const overBudget = keysSpent > KEY_BUDGET;
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {/* Live remaining-key counter — sticky so it's visible while scrolling the list. */}
      <div
      ...
      >
        ...
        <div className="mt-2 h-2 overflow-hidden rounded-full bg-gray-200">
          <div
            ...
            style={{ width: `${Math.min(100, (keysSpent / KEY_BUDGET) * 100)}%` }}
          />
        </div>
      </div>
