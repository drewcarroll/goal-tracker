...
export const CHART_COLORS = {
  ...
  pass: "#10b981", // emerald-500 — "if you pass" ghost projection / pass-day dot
  fail: "#ef4444", // red-500 — "if you fail" ghost projection / miss-day dot
  history: "#7c3aed", // violet-600 — the real (non-projected) strength line
} as const;
