...
import { GetHabitStatsUseCase } from "@/application/use-cases/GetHabitStatsUseCase";
...
function buildContainer() {
  ...
  return {
    ...
    getHabitStatsUseCase: new GetHabitStatsUseCase(habitRepository, checkInRepository),
